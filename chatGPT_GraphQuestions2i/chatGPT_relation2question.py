...
def relation2question():
    ...
    useful_relation_file_2i = "./data/GraphQuestions-2i/test-queries.pkl"
    useful_relation_file_2i = pickle.load(open(useful_relation_file_2i, "rb"))
    useful_relation_file_2i = useful_relation_file_2i[(('e', ('r',)), ('e', ('r',)))] 
    
    # read relation dict
    relation_dict_file = "./data/GraphQuestions-2i/id2rel.pkl"
    relation_dict_file = pickle.load(open(relation_dict_file, "rb"))
    
    useful_relation_set = set()
    for value in useful_relation_file_2i:
        useful_relation_set.add(relation_dict_file[value[0][1][0]])
        useful_relation_set.add(relation_dict_file[value[1][1][0]])
    
    if os.path.exists("./chatGPT_GraphQuestions2i/chatGPT_GraphQuestions_relation2text.pkl"):
        with open("./chatGPT_GraphQuestions2i/chatGPT_GraphQuestions_relation2text.pkl", "rb") as input_file:
    ...
    try:
        ...
        # store res
        with open('./chatGPT_GraphQuestions2i/chatGPT_GraphQuestions_relation2text.pkl', 'wb') as handle:
