...
def process():
    ...
    file_name = "chatGPT_GraphQuestions2i/GraphQuestions_good_2intersect_test.pkl"
    with open(file_name, 'rb') as f:
        datas_test = pickle.load(f)
        
    file_name_train = "chatGPT_GraphQuestions2i/GraphQuestions_good_2intersect_train.pkl" # merge train and test together, because the data is too few. 
    with open(file_name_train, 'rb') as f:
        ...
        for line in datas:
            ...
            try:
                data = ((ent2id[entity1[0]], (rel2id[rel1],)), (ent2id[entity2[0]], (rel2id[rel2],)))
            except:
                print(line)
                traceback.print_exc()
                continue
