...
if os.path.exists("./chatGPT_GraphQuestions2i/example_GraphQuestions_good_2intersect_test_relation2.pkl"):
    with open("./chatGPT_GraphQuestions2i/example_GraphQuestions_good_2intersect_test_relation2.pkl", "rb") as input_file:
...
try:
    ...
    with open('./chatGPT_GraphQuestions2i/example_GraphQuestions_good_2intersect_test_relation2.pkl', 'wb') as handle:
