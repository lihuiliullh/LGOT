...
def check():
    ...
    file_name = "./chatGPT_GraphQuestions2i/evidence_GraphQuestions2i_full.txt"
...
def process():
    ...
    a = 0
    # write to file
    with open('./chatGPT_GraphQuestions2i/evidence_2i_GraphQuestions_full.pkl', 'wb') as handle:
