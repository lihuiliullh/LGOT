...
if os.path.exists("./chatGPT_GraphQuestions2i/example_chatGPT_GraphQuestions2i_test_evaluate.pkl"):
    res = pickle.load(open("./chatGPT_GraphQuestions2i/example_chatGPT_GraphQuestions2i_test_evaluate.pkl", "rb"))
else:
    res = {}
...
try:
    for ele in question:
        ...
        prompt = 'I will give you a question and several candidate answers. Please output at most 10 answers for this question in a json format. The output json has only key "answer entity"\n'
        prompt = prompt + "Replace the answers with correct answers if the answers in the choices are not correct\n"
        prompt = prompt + "Example:\nQ: movie interstellar directed by who?\n"
        prompt = prompt + 'Candidate answer0: "Matthew McConaughey"\n'
        prompt = prompt + 'Candidate answer1: "Anne Hathaway"\n'
        prompt = prompt + 'Candidate answer2: "Tom Hanks"\n'
        prompt = prompt + 'Candidate answer3: "Christopher Nolan"\n'
        prompt = prompt + 'Candidate answer4: "Jessica Chastain"\n'
        prompt = prompt + 'Candidate answer5: "Bill Irwin"\n'
        prompt = prompt + 'Candidate answer6: "Ellen Burstyn"\n'
        prompt = prompt + 'Candidate answer7: "Michael Caine"\n'
        prompt = prompt + 'Candidate answer8: "Tom Caine"\n'
        prompt = prompt + 'Candidate answer9: "Jack"\n'
        prompt = prompt + 'A: {"answer entity": ["Christopher Nolan", "Matthew McConaughey", "Anne Hathaway", "Jessica Chastain", "Bill Irwin", "Ellen Burstyn", "Michael Caine", "Tom Hanks", "Tom Caine", "Jack"]}\n'
    ...
    # store res
    with open('./chatGPT_GraphQuestions2i/example_chatGPT_GraphQuestions2i_test_evaluate.pkl', 'wb') as handle:
